...
\tikzset{
  >=latex,
  help lines/.append style={line width=0.3pt},
  radius=\pgfplotmarksize,
...
\DeclareMathOperator{\Elias}{Elias}
...
\newcommand{\levelable}[1]{#1\babelhyphen{nobreak}semi-levelable}
